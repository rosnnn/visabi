...
import { tradingSolution, heroImages } from '../data/mock';
import tradingStreamlinedInventory from '../components/animations/trading-and-distribution/Streamlined Inventory Management.json';
import tradingImprovedService from '../components/animations/trading-and-distribution/Improved Service Levels.json';
import tradingFinancial from '../components/animations/trading-and-distribution/Financial Management.json';
import tradingProcurement from '../components/animations/trading-and-distribution/Procurement Process.json';

const tradingAnimationMap = {
  'Streamlined Inventory Management': tradingStreamlinedInventory,
  'Improved Service Levels': tradingImprovedService,
  'Financial Management': tradingFinancial,
  'Procurement Process': tradingProcurement,
};
    ...
    <div className="bg-slate-950 min-h-screen">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-4xl mx-auto text-center space-y-6">
            <h1 className="text-5xl lg:text-6xl font-bold text-white leading-tight animate-fade-in-up">
              <span className="gradient-text">{tradingSolution.title}</span>
            </h1>
            <p className="text-2xl text-slate-200 animate-fade-in-up delay-200">
              {tradingSolution.subtitle}
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-16 fade-in-up-init">
            <h2 className="text-4xl lg:text-5xl font-bold text-white mb-4">
              Business <span className="gradient-text">Challenges</span>
            </h2>
            <p className="text-xl text-slate-300">Key challenges facing the Trading & Distribution industry</p>
          </div>

          <div className="max-w-2xl mx-auto space-y-0">
            {tradingSolution.challenges.map((challenge, index) => (
              <div key={index} className="fade-in-up-init" style={{ animationDelay: `${index * 80}ms` }}>
                ...
                {index < tradingSolution.challenges.length - 1 && (
      ...
      <section className="py-20 lg:py-32 relative">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-16 fade-in-up-init">
            <h2 className="text-4xl lg:text-5xl font-bold text-white mb-4">
              How <span className="gradient-text">WEB ERP</span> Transforms Your Business
            </h2>
            <p className="text-xl text-slate-300">Comprehensive solutions for Trading & Distribution</p>
          </div>

          <div className="space-y-20">
            {tradingSolution.solutions.map((solution, index) => (
              <div 
                key={index}
                ...
                <div className="flex-1">
                  <div className="relative group">
                    ...
                    <div className="relative rounded-3xl shadow-2xl w-full h-80 overflow-hidden flex items-center justify-center bg-slate-900/40 hover-lift">
                      <Lottie
                        animationData={tradingAnimationMap[solution.title] || tradingStreamlinedInventory}
                        loop
                        autoplay
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="glass-effect-dark rounded-3xl p-12 lg:p-20 text-center space-y-8 max-w-4xl mx-auto fade-in-up-init">
            <h2 className="text-4xl lg:text-5xl font-bold text-white">
              Transform Your <span className="gradient-text">Trading Business</span>
            </h2>
            <p className="text-xl text-slate-200">
              Discover how our ERP solution can streamline your operations and boost profitability
            </p>
